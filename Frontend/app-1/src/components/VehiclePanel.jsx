    ...
    return (
       <div>
            ...
            <div onClick={()=>{
                ...
                <h2 className='text-lg font-semibold'>R.s {fare.car}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmVehicle(true)
                ...
                <h2 className='text-lg font-semibold'>R.s {fare.moto}</h2>
            </div>
            <div onClick={()=>{
                props.setConfirmVehicle(true)
                ...
                <h2 className='text-lg font-semibold'>R.s {fare.auto}</h2>
            </div>
        </div>
    )
}
